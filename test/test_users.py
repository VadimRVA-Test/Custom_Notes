...
class TestUsers:
    ...
    def test_registration(self, obj_registration):
        response = obj_registration.registration_user(data_user2["email"], data_user["password"],
                                                      data_user2["username"])
    ...
    def test_registration_resource_conflict(self, obj_registration):
        response = obj_registration.registration_user(data_user["email"], data_user["password"], data_user2["username"])
